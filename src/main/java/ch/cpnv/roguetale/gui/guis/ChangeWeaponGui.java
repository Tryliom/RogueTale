...
public class ChangeWeaponGui extends Gui {
	...
	public ChangeWeaponGui(Gui prevGui, Weapon weapon) {
		...
		this.buttonList.add(new ChooseLeftWeaponButton(width/4 - 20, height*3/4, this, weapon));
		this.buttonList.add(new KeepWeaponsButton(width/2, height*3/4, this));
		this.buttonList.add(new ChooseRightWeaponButton(3*width/4 + 20, height*3/4, this, weapon));
	}
