...
public class PlayerController {
	...
	public PlayerController() throws SlickException {
		this.player = new Player(new SpriteSheet("ch\\cpnv\\roguetale\\images\\player\\carac.png", 48, 48, 0), new Vector2f(0,0), 10000000, Direction.DOWN, false, new Knife(), new Bow());
